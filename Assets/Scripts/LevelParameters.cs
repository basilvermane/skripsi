...
public static class LevelParameters {
	...
	public static LevelParam[] LevelParams = {
		...
		new LevelParam(20.0f, 300, 300, 600, 100.0f), //5
		new LevelParam(9.8f, 500, 500, 600, 200.0f), //6
		new LevelParam(9.8f, 100, 100, 300, 100.0f), //7
		new LevelParam(20.0f, 300, 300, 600, 100.0f), //8
		new LevelParam(9.8f, 500, 500, 600, 200.0f), //9
		new LevelParam(9.8f, 100, 100, 300, 100.0f), //10
		new LevelParam(20.0f, 300, 300, 600, 100.0f), //sandbox default
	};
}
